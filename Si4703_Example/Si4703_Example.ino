/*
 ...
 July-15-2016
 Atommann
 Adapt it for szdiy7thduino
 https://github.com/danfei/LCD7th
 https://sites.google.com/site/atommann2/szdiy7thduino
 
 This code is public domain but you buy me a beer if you use this and we meet someday (Beerware license).
 
 To use this code, connect the following 5 wires:
 szdiy7thduino : Si470x board
 3.3V : VCC
 GND : GND
 SCL : SCLK
 SDA : SDIO
...
int STATUS_LED = 10; // use the LCD backlight :)
int resetPin = 15;   // SCK, can not use SW1
int SDIO = 2;        //SDA on szdiy7thduino
int SCLK = 3;        //SCL on szdiy7thduino
char printBuffer[50];
